...
class ArticleAdapter(private val items: MutableList<ArticleItem>, private val onOpenWebViewListener: ArticleViewHolder.OnOpenWebViewListener) : RecyclerView.Adapter<ArticleViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticleViewHolder {
        return ArticleViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_article, parent, false), onOpenWebViewListener)
    }
